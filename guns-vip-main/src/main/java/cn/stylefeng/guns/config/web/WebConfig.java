...
public class WebConfig implements WebMvcConfigurer {
    ...
    public FilterRegistrationBean xssFilterRegistration() {
        ...
        xssFilter.setUrlExclusion(Arrays.asList("/notice/add", "/notice/update", "/excelExportDeploy/editItem", "/excelExportDeploy/addItem","/meet/addItem","/meet/editItem"));
    ...
    public DefaultKaptcha kaptcha() {
        ...
        properties.put("kaptcha.textproducer.char.string", "abcde2345678fnmnwx");
