layui.use(['table', 'admin', 'ax', 'func'], function () {
    ...
    Thesis.initColumn = function () {
        return [[
            ...
            {field: 'reviewResult', sort: true, title: '评审结果; 0-不通过，1-通过'},
            {field: 'isgreat', sort: true, title: '是否推荐优秀; 0-否，1-是'},
            {field: 'greatNum', sort: true, title: '推荐专家人数'},
            {field: 'greatId', sort: true, title: '推优专家ID,多个用逗号隔开'},
            {field: 'applyTime', sort: true, title: '论文提交时间'},
            {field: 'thesisText', sort: true, title: '正文'},
            {field: 'score', sort: true, title: '分数'},
            {field: 'reviewUser', sort: true, title: '评审人ID,多个用逗号隔开'},
            {field: 'great', sort: true, title: '是否为优秀论文;0-否,1-是'},
